...
namespace AppMvc.Areas.SaleManagement.Controllers
{
    ...
    public class DetailBillController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PriceId,ProductId,BillId,Amount")] DetailBill detailBill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PriceId,ProductId,BillId,Amount")] DetailBill detailBill)
        {
            if (id != detailBill.PriceId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!DetailBillExists(detailBill.PriceId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.DetailBills.Any(e => e.PriceId == id);
        }
    }
}
